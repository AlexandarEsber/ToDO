...
const formSchema = toTypedSchema(z.object({
    ...
    dueDate: z.date(z.number()).optional(),
    dob: z
        .string()
        .optional()
}))
...
const { handleSubmit, setFieldValue, values } = useForm({
    ...
    initialValues: {
        ...
        assigneeIdList: props.todoAssigneeIdList,
        dob: props.todoDueDate ? new Date(props.todoDueDate).toLocaleDateString('en-CA') : ""
    },
})
...
const onSubmit = handleSubmit((values) => {
    var todo = {
        ...
        finished: props.todoFinished,
        finishedDate: props.todoFinishedDate
    }
...
// Watch for changes in the dialog open state
watch(dialogOpen, (isOpen) => {
    if (isOpen) {
        // Reset form values when the dialog is opened
        setFieldValue('title', props.todoTitle);
        setFieldValue('description', props.todoDescription);
        setFieldValue('assigneeIdList', props.todoAssigneeIdList || []);
        setFieldValue('dob', props.todoDueDate ? new Date(props.todoDueDate).toLocaleDateString('en-CA') : "");
    }
});
        ...
        <DialogContent class="sm:max-w-[425px]">
            <form @submit="onSubmit">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Fill in the form to edit a todo.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div class="grid gap-4 py-4">
                    ...
                    <FormField name="assigneeIdList">
                        <FormItem>
                            ...
                            <FormField v-for="item in props.assignees" v-slot="{ value, handleChange }" :key="item.id"
                                type="checkbox" :value="item.id" :unchecked-value="false" name="assigneeIdList">
                        ...
                        <FormItem class="flex flex-col mt-2">
                            ...
                            <Popover>
                                ...
                                <PopoverContent class="w-auto p-0 z-50">
                                    <Calendar v-model:placeholder="placeholder" v-model="value"
