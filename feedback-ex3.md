...
| ----------------------------- | ---------------------------------- |
| Frontend-Funktionalität       | 20 / 22                            |
| Usability                     | 2 / 3                             |
| Repository, Config und README | 4 / 5                             |
| **Summe**:                    | 26 / 30                            |
| **Bestanden**:                | ja                          |

## Funktionalität des Frontends (__ / 22)
...
- [x] (9 / 11 Punkte) View zur Verwaltung von `ToDos`
...
- [x] (1 Punkt) Gängige UI Components werden passend eingesetzt (z.B. Tables, Menus/Selects, Inputs, Switches, Toasts/Dialogs/Alerts etc.) - Confirmation-Dialog bei Delete fehlt
...
- [ ] (1 Punkt) DB- und API-Konfiguration entspricht dem Beispielprojekt (keine Änderungen für Korrektur nötig)
